    ...
    return [
        {
            ...
            create() {
                ...
                const addToChatButtton = document.createElement("button");
                addToChatButtton.textContent = "Add to Chat";
                addToChatButtton.className =
                ...
                dom.appendChild(addToChatButtton);
